...
import { IPendingJob, IPendingJobDetail } from '../../../../redux/models/pending-job';

interface JobPropertiesProps {
    job_detail?: IPendingJobDetail;
}

export default function JobProperties(props: JobPropertiesProps) {
    let { job_detail } = props;
    ...
    return (
        <div className='job-detail'>
            <div className='detail-job b_b'>
                ...
                <ul>
                    ...
                    <li className='d_j_t'>
                        ...
                        <label> {job_detail && job_detail.jobNameID ? job_detail.jobNameID : "Không có"}
                        </label>
                    </li>
                    <li className='d_j_t'>
            ...
            <div className='detail-job b_b'>
                ...
                <ul>
                    <li className='d_j_t'>
                        ...
                        <label> {job_detail && job_detail.jobType}
                        </label>
                    </li>
                    <li className='d_j_t'>
            ...
            <div className='time-job b_t'>
                <h6>CA LÀM VIỆC</h6>
                <div>
                    {job_detail && job_detail.shifts.map((item: any, index: number) => {
            ...
            <div className='skills-job-detail '>
                ...
                <div>
                    {job_detail &&
                        job_detail.requiredSkillIDs &&
                        job_detail.requiredSkillIDs.length > 0 ?
                        job_detail.requiredSkillIDs.map(
