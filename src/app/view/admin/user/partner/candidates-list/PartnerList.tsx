...
class PartnerList extends React.Component<IPartnerListProps, IPartnerListState> {
    constructor(props) {
        super(props);
        this.state = {
            data_table: [],
    ...
    searchCandidate = async () => {
        ...
        await this.props.getListPartner(body, pageIndex, pageSize);
    };
...
const mapDispatchToProps = (dispatch: any, ownProps: any) => ({
    getListPartner: (body: ICandidateFilter, pageIndex: number, pageSize: number) =>
...
const mapStateToProps = (state: IAppState, ownProps: any) => ({
    // list_find_candidates: state.Partner.items,
    // totalItems: state.Partner.totalItems,
